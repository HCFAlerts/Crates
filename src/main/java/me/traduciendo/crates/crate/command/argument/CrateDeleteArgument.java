...
public class CrateDeleteArgument extends CommandArgument {
	...
	public CrateDeleteArgument() {
		super("delete", "Delete a crate.", "crate.command.delete", new String[] { "delete", "del", "rem" });
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		ChatUtil.sendMessage(sender, "&7[&bCrates&7] &aYou have deleted the &l" + args[0] + "&a crate.");
		return false;
	}

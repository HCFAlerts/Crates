...
public class CC {
    ...
    public static void logWith(String msg) {
        Bukkit.getConsoleSender().sendMessage(CC.translate("&e[&b" + Crates.getInstance().getName() + "&e]&r " + msg));
    }

    public static void logWith(List<String> msg) {
        msg.forEach(msgs -> Bukkit.getConsoleSender().sendMessage(CC.translate("&e[&b" + Crates.getInstance().getName() + "&e]&r " + msgs)));
    }
}

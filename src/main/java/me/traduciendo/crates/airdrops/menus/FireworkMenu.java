        ...
        public ItemStack getButtonItem(final Player player){
            if(airdrop.getFireworkpower()==1){
                return new ItemBuilder
                        ...
                        .setName(CC.translate("&aChange Power"))
            ...
            return new ItemBuilder
                    (CompatibleMaterial.FIREBALL.getMaterial())
                    .setName(CC.translate("&bChange Power"))
                    .setLore(Lists.newArrayList(
                            CC.translate("&71"),
                            CC.translate("&72"),
                            CC.translate("&b┃ &a3")
        ...
        public ItemStack getButtonItem(final Player player){
            ...
            if(airdrop.getFireworktype() == FireworkEffect.Type.STAR){
                return new ItemBuilder(CompatibleMaterial.PAINTING.getMaterial())
                        ...
                        .setName(CC.translate("&aChange Type"))
                        .setLore(Lists.newArrayList(
                                CC.translate("&b┃ &aSTAR"),
            ...
            return new ItemBuilder(CompatibleMaterial.PAINTING.getMaterial())
                    ...
                    .setLore(Lists.newArrayList(
                            ...
                            CC.translate("&7BURST"),
                            CC.translate("&7BALL"),
                            CC.translate("&b┃ &aBALL_LARGE"))).toItemStack();
        }
        ...
        public ItemStack getButtonItem(final Player player){
            ...
            if(airdrop.getFireworkcolor() == Color.BLACK){
                return new ItemBuilder(CompatibleMaterial.INK_SACK.getMaterial())
                        .setDurability(0)
                        .setName(CC.translate("&aChange Color"))
                        .setLore(Lists.newArrayList(
                                CC.translate("&8&m-----------------------------"),
                                CC.translate("&7Click to change the color."),
                                CC.translate("&8&m-----------------------------")
                        ))
                        .toItemStack();
            }
        ...
        public ItemStack getButtonItem(final Player player){
            if(airdrop.isFireworkenabled()){
                return new ItemBuilder
                        ...
                        .setLore(Lists.newArrayList(
                                CC.translate("&8&m-----------------------------"),
                                CC.translate("&7Click to toggle the particles."),
                                CC.translate("&8&m-----------------------------")
                        ))
                        .toItemStack();
            }else {

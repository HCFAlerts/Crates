package me.traduciendo.crates.airdrops.rewards;
...
public class Airdrop {
    ...
    private static Crates plugin = Crates.getInstance();
    ...
    public static void loadAirdrops(){
        ...
        for(String string : config.getConfigurationSection("AIRDROPS").getKeys(false)){
            ...
            int fireworkpower = config.getInt("AIRDROPS."+string+".FIREWORK.POWER", 1);
            ...
            public void run() {
                if (fallingBlock.isDead())
                    try {
                        ...
                        if (!dropper.isPlaced())
                            return;
                        dropper.setMetadata("airdrop", (MetadataValue) new FixedMetadataValue(Crates.getInstance(), "airdrop"));
